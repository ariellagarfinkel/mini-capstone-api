product = Product.new(name: "computer", price: 500, description: "A device that computes")
product.save
product = Product.new(name: "waterbottle", price: 2, description: "something to drink")
product.save
