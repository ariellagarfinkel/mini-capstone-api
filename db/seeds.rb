...
product = Product.create!(name: "computer", price: 500, description: "A device that computes", quantity: 1, supplier_id: 1)

product = Product.create!(name: "waterbottle", price: 2, description: "something to drink", quantity: 1, supplier_id: 1)
